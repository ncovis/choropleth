  ...
  "objects": {
    "provinces": {
      ...
      "geometries": [{
        ...
        "arcs": [[463, 464, -167, 465, -219, -109, -389, 466]],
        "type": "Polygon",
        "properties": {
          "OBJECTID": 73,
          "NAME": "巢湖市",
          "KIND": "0137",
          "Shape_Length": 5.064869226097987,
          "Shape_Area": 0.8979848090319963
        }
      }, {
...
(0, _fetchJsonp.default)('https://interface.sina.cn/news/wap/fymap2020_data.d.json').then(function (response) {
  ...
  fetch(censUrl).then(function (res) {
    ...
    var paint = d3.scalePow().interpolate(function () {
      return d3.interpolateInferno;
    }).exponent(0.3).domain([0, 500]); // .range(["#222", "yellow"])

    var paint2 = d3.scaleSequential(d3.interpolateViridis).domain([0, maxInfection]);
    d3.select("svg-frame").append("svg").attr("viewBox", [0, 0, 875, 910]).append("g").selectAll("path").data(topojson.feature(china, china.objects.provinces).features).join("path").attr("fill", function (d) {
...
},{"fetch-jsonp":"node_modules/fetch-jsonp/build/fetch-jsonp.js","./data/china-proj.topo.json":"data/china-proj.topo.json","./data/2010-census.csv":"data/2010-census.csv"}],"C:/Users/Tzingtao/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/Tzingtao/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
//# sourceMappingURL=/ncov-src.e31bb0bc.js.map